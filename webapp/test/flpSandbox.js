		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comporderspordersapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comporderspordersapp-display": {
								"semanticObject": "comporderspordersapp",
								"action": "display",
								"description": "Purchase Orders List Application",
								"title": "Purchase Orders List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.porders.pordersapp",
									"url": sap.ui.require.toUrl("com/porders/pordersapp")
								}
							}
						}
					}
